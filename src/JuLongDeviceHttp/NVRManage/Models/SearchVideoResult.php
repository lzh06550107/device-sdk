...
class SearchVideoResult extends AbstractModel
{
    /**
     * @var int 列表最大数量5000
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("List", $param) and $param["List"] !== null) {
            ...
            foreach ($param['List'] as $searchVideo) {
                $searchVideoObj = new SearchVideo();
