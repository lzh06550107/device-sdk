...
//    $clientProfile->setDevicePassword("admin");
    ...
    // 通过client对象调用 upgradeDevice 方法发起请求。注意请求方法名与请求对象是对应的
    // 返回的resp是一个 UpgradeDeviceResponse 类的实例，与请求对象对应
    $resp = $client->upgradeDevice($req);
