...
use JuLongDeviceHttp\AccessStrategy\Models\IdentityChangeRequest;
...
//    $clientProfile->setDevicePassword("admin");
    ...
    $req->FromIdentity = PersonIdentity::$TEACHER;
    $req->ToIdentity = PersonIdentity::$DAY_STUDENT;

    // 通过client对象调用 identityChange 方法发起请求。注意请求方法名与请求对象是对应的
    // 返回的resp是一个 IdentityChangeResponse 类的实例，与请求对象对应
    $resp = $client->identityChange($req);
