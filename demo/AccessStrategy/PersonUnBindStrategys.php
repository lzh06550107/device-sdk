...
use JuLongDeviceHttp\AccessStrategy\Models\PersonUnBindStrategysRequest;
...
//    $clientProfile->setDevicePassword("admin");
    ...
    $req = new PersonUnBindStrategysRequest();
    $req->TimeStamp = time();
    // 需要设备开启注册
    $req->Session = 'fdjlsfjeowjfldsfa';

    $personBindStrategys = new PersonStrategys();
    $personBindStrategys->PersonId = "1";
    $personBindStrategys->StrategyTable = [1];

    $req->List = [$personBindStrategys];
