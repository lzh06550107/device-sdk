...
use JuLongDeviceHttp\ParamSetting\Models\SetSIMCardRequest;
use JuLongDeviceHttp\ParamSetting\Models\SIMCard;
...
//    $clientProfile->setDevicePassword("admin");
    ...
    // 通过client对象调用 setSIMCard 方法发起请求。注意请求方法名与请求对象是对应的
    // 返回的resp是一个 SetSIMCardResponse 类的实例，与请求对象对应
    $resp = $client->setSIMCard($req);
