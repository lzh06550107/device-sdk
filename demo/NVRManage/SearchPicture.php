...
//    $clientProfile->setDevicePassword("admin");
    ...
    $req = new SearchPictureRequest();
    $req->TimeStamp = time();
    // 需要设备开启注册
    $req->Session = 'fdjlsfjeowjfldsfa';

    $searchVideoParam = new SearchPictureParam();
    ...
    // 通过client对象调用 searchPicture 方法发起请求。注意请求方法名与请求对象是对应的
    // 返回的resp是一个 SearchPictureResponse 类的实例，与请求对象对应
    $resp = $client->searchPicture($req);
