...
use JuLongDeviceHttp\AccessControlPassword\Models\GetPasswordsRequest;
...
//    $clientProfile->setDevicePassword("admin");
    ...
    $passwordInfo->PasswordId = 'passwordId1';

    $req->PasswordInfo = $passwordInfo;
