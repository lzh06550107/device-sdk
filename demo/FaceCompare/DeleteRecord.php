...
use JuLongDeviceHttp\FaceCompare\Models\DeleteRecord;
use JuLongDeviceHttp\FaceCompare\Models\DeleteRecordRequest;
...
//    $clientProfile->setDevicePassword("admin");
    ...
    $deleteRecord->Mode = 1;
    $deleteRecord->BeginTime = "2021-01-01 00:00:00";
    $deleteRecord->EndTime = "2021-12-31 590:59:00";
    $deleteRecord->RecordId = 1;

    $req->Data = $deleteRecord;

    // 通过client对象调用 deleteRecord 方法发起请求。注意请求方法名与请求对象是对应的
    // 返回的resp是一个 DeleteRecordResponse 类的实例，与请求对象对应
